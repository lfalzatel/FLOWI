    ...
    <div className="min-h-screen bg-deep flex flex-col">
      ...
      <main className="flex-1 p-4 pb-24 max-w-2xl mx-auto w-full">
        <div className="mb-6 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-syne font-bold text-text-primary">Mis Gastos</h1>
            <p className="text-text-secondary text-sm mt-1">Historial completo de tus salidas</p>
          </div>
          <button
        ...
        {/* Card de Total */}
        <div className="relative overflow-hidden rounded-3xl p-6 mb-6 bg-card border border-[var(--red)]/20 shadow-sm">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-medium text-text-secondary">Total Gastado</span>
            </div>
